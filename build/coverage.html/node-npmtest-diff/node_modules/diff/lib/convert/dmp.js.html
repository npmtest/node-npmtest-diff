...
<html lang="en">
<head>
    <title>Code coverage report for node-npmtest-diff/node_modules/diff/lib/convert/dmp.js</title>
    <meta charset="utf-8">
    <style>
        body, html {
            margin:0; padding: 0;
...
<div class="header low">
    ...
    <h1>Code coverage report for <span class="entity">node-npmtest-diff/node_modules/diff/lib/convert/dmp.js</span></h1>
    <h2>
    ...
    <div class="path"><a href="../../../../../index.html">All files</a> &#187; <a href="index.html">node-npmtest-diff/node_modules/diff/lib/convert/</a> &#187; dmp.js</div>
</div>
<div class="body">
...
<span class="fstat-no" title="function not covered" >function convertChangesToDMP(changes) {</span>
...
<span class="cstat-no" title="statement not covered" >      operation = 1;</span>
    } else <span class="cstat-no" title="statement not covered" >if (change.removed) {</span>
<span class="cstat-no" title="statement not covered" >      operation = -1;</span>
    } else {
<span class="cstat-no" title="statement not covered" >      operation = 0;</span>
    }
&nbsp;
<span class="cstat-no" title="statement not covered" >    ret.push([operation, change.value]);</span>
  }
