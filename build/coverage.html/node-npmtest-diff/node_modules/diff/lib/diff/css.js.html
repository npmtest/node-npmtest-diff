...
<html lang="en">
<head>
    <title>Code coverage report for node-npmtest-diff/node_modules/diff/lib/diff/css.js</title>
    <meta charset="utf-8">
    <style>
        body, html {
            margin:0; padding: 0;
...
<div class="header high">
    ...
    <h1>Code coverage report for <span class="entity">node-npmtest-diff/node_modules/diff/lib/diff/css.js</span></h1>
    <h2>
    ...
    <div class="path"><a href="../../../../../index.html">All files</a> &#187; <a href="index.html">node-npmtest-diff/node_modules/diff/lib/diff/</a> &#187; css.js</div>
</div>
<div class="body">
...
<span class="cstat-no" title="statement not covered" >  return value.split(/([{}:;,]|\s+)/);</span>
};
&nbsp;
<span class="fstat-no" title="function not covered" >function diffCss(oldStr, newStr, callback) {</span>
<span class="cstat-no" title="statement not covered" >  return cssDiff.diff(oldStr, newStr, callback);</span>
}
