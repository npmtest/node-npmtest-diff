...
<html lang="en">
<head>
    <title>Code coverage report for node-npmtest-diff/node_modules/diff/lib/patch/apply.js</title>
    <meta charset="utf-8">
    <style>
        body, html {
            margin:0; padding: 0;
...
<div class="header low">
    ...
    <h1>Code coverage report for <span class="entity">node-npmtest-diff/node_modules/diff/lib/patch/apply.js</span></h1>
    <h2>
        
        Statements: <span class="metric">20.93% <small>(18 / 86)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        
        
        Branches: <span class="metric">20% <small>(12 / 60)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        ...
        Ignored: <span class="metric">6 statements, 9 branches</span> &nbsp;&nbsp;&nbsp;&nbsp;
    </h2>
    <div class="path"><a href="../../../../../index.html">All files</a> &#187; <a href="index.html">node-npmtest-diff/node_modules/diff/lib/patch/</a> &#187; apply.js</div>
</div>
<div class="body">
...
&nbsp;
/*istanbul ignore end*/<span class="fstat-no" title="function not covered" >function applyPatch(source, uniDiff) {</span>
...
&nbsp;
<span class="cstat-no" title="statement not covered" >  if (typeof uniDiff === 'string') {</span>
<span class="cstat-no" title="statement not covered" >    uniDiff = /*istanbul ignore start*/(0, _parse.parsePatch) /*istanbul ignore end*/(uniDiff);</span>
  }
&nbsp;
<span class="cstat-no" title="statement not covered" >  if (Array.isArray(uniDiff)) {</span>
<span class="cstat-no" title="statement not covered" >    if (uniDiff.length &gt; 1) {</span>
<span class="cstat-no" title="statement not covered" >      throw new Error('applyPatch only works with a single input.');</span>
    }
&nbsp;
<span class="cstat-no" title="statement not covered" >    uniDiff = uniDiff[0];</span>
  }
&nbsp;
  // Apply the diff to the input
<span class="cstat-no" title="statement not covered" >  var lines = source.split(/\r\n|[\n\v\f\r\x85]/),</span>
      delimiters = source.match(/\r\n|[\n\v\f\r\x85]/g) || [],
      hunks = uniDiff.hunks,
      compareLine = options.compareLine || <span class="fstat-no" title="function not covered" >function (lineNumber, line, operation, patchContent) /*istanbul ignore start*/{</span>
<span class="cstat-no" title="statement not covered" >    return (/*istanbul ignore end*/line === patchContent</span>
    );
  },
      errorCount = 0,
...
&nbsp;
   ...
   */
<span class="fstat-no" title="function not covered" >  function hunkFits(hunk, toPos) {</span>
<span class="cstat-no" title="statement not covered" >    for (var j = 0; j &lt; hunk.lines.length; j++) {</span>
<span class="cstat-no" title="statement not covered" >      var line = hunk.lines[j],</span>
          operation = line[0],
          content = line.substr(1);
&nbsp;
<span class="cstat-no" title="statement not covered" >      if (operation === ' ' || operation === '-') {</span>
        // Context sanity check
<span class="cstat-no" title="statement not covered" >        if (!compareLine(toPos + 1, lines[toPos], operation, content)) {</span>
<span class="cstat-no" title="statement not covered" >          errorCount++;</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >          if (errorCount &gt; fuzzFactor) {</span>
<span class="cstat-no" title="statement not covered" >            return false;</span>
          }
        }
<span class="cstat-no" title="statement not covered" >        toPos++;</span>
      }
    }
&nbsp;
...
<span class="cstat-no" title="statement not covered" >  for (var i = 0; i &lt; hunks.length; i++) {</span>
<span class="cstat-no" title="statement not covered" >    var hunk = hunks[i],</span>
        maxLine = lines.length - hunk.oldLines,
        localOffset = 0,
        toPos = offset + hunk.oldStart - 1;
&nbsp;
<span class="cstat-no" title="statement not covered" >    var iterator = /*istanbul ignore start*/(0, _distanceIterator2['default']) /*istanbul ignore end*/(toPos, minLine, maxLine);</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >    for (; localOffset !== undefined; localOffset = iterator()) {</span>
<span class="cstat-no" title="statement not covered" >      if (hunkFits(hunk, toPos + localOffset)) {</span>
<span class="cstat-no" title="statement not covered" >        hunk.offset = offset += localOffset;</span>
<span class="cstat-no" title="statement not covered" >        break;</span>
      }
    }
&nbsp;
<span class="cstat-no" title="statement not covered" >    if (localOffset === undefined) {</span>
<span class="cstat-no" title="statement not covered" >      return false;</span>
    }
&nbsp;
    // Set lower text limit to end of the current hunk, so next ones don't try
    // to fit over already patched text
<span class="cstat-no" title="statement not covered" >    minLine = hunk.offset + hunk.oldStart + hunk.oldLines;</span>
  }
&nbsp;
  // Apply patch hunks
<span class="cstat-no" title="statement not covered" >  for (var _i = 0; _i &lt; hunks.length; _i++) {</span>
<span class="cstat-no" title="statement not covered" >    var _hunk = hunks[_i],</span>
        _toPos = _hunk.offset + _hunk.newStart - 1;
<span class="cstat-no" title="statement not covered" >    if (_hunk.newLines == 0) {</span>
<span class="cstat-no" title="statement not covered" >      _toPos++;</span>
    }
&nbsp;
<span class="cstat-no" title="statement not covered" >    for (var j = 0; j &lt; _hunk.lines.length; j++) {</span>
<span class="cstat-no" title="statement not covered" >      var line = _hunk.lines[j],</span>
          operation = line[0],
          content = line.substr(1),
...
<span class="cstat-no" title="statement not covered" >        _toPos++;</span>
      } else <span class="cstat-no" title="statement not covered" >if (operation === '-') {</span>
<span class="cstat-no" title="statement not covered" >        lines.splice(_toPos, 1);</span>
<span class="cstat-no" title="statement not covered" >        delimiters.splice(_toPos, 1);</span>
        /* istanbul ignore else */
      } else <span class="cstat-no" title="statement not covered" >if (operation === '+') {</span>
<span class="cstat-no" title="statement not covered" >          lines.splice(_toPos, 0, content);</span>
<span class="cstat-no" title="statement not covered" >          delimiters.splice(_toPos, 0, delimiter);</span>
<span class="cstat-no" title="statement not covered" >          _toPos++;</span>
        } else <span class="cstat-skip" title="statement not covered" >if (operation === '\\') {</span>
<span class="cstat-skip" title="statement not covered" >          var previousOperation = _hunk.lines[j - 1] ? _hunk.lines[j - 1][0] : null;</span>
<span class="cstat-skip" title="statement not covered" >          if (previousOperation === '+') {</span>
<span class="cstat-skip" title="statement not covered" >            removeEOFNL = true;</span>
          } else <span class="cstat-skip" title="statement not covered" >if (previousOperation === '-') {</span>
<span class="cstat-skip" title="statement not covered" >            addEOFNL = true;</span>
          }
        }
    }
  }
...
<span class="cstat-no" title="statement not covered" >  if (removeEOFNL) {</span>
<span class="cstat-no" title="statement not covered" >    while (!lines[lines.length - 1]) {</span>
<span class="cstat-no" title="statement not covered" >      lines.pop();</span>
<span class="cstat-no" title="statement not covered" >      delimiters.pop();</span>
    }
...
<span class="cstat-no" title="statement not covered" >    delimiters.push('\n');</span>
  }
<span class="cstat-no" title="statement not covered" >  for (var _k = 0; _k &lt; lines.length - 1; _k++) {</span>
<span class="cstat-no" title="statement not covered" >    lines[_k] = lines[_k] + delimiters[_k];</span>
  }
<span class="cstat-no" title="statement not covered" >  return lines.join('');</span>
}
&nbsp;
// Wrapper that supports multiple file patches via callbacks.
<span class="fstat-no" title="function not covered" >function applyPatches(uniDiff, options) {</span>
<span class="cstat-no" title="statement not covered" >  if (typeof uniDiff === 'string') {</span>
<span class="cstat-no" title="statement not covered" >    uniDiff = /*istanbul ignore start*/(0, _parse.parsePatch) /*istanbul ignore end*/(uniDiff);</span>
  }
&nbsp;
<span class="cstat-no" title="statement not covered" >  var currentIndex = 0;</span>
<span class="fstat-no" title="function not covered" >  function processIndex() {</span>
<span class="cstat-no" title="statement not covered" >    var index = uniDiff[currentIndex++];</span>
<span class="cstat-no" title="statement not covered" >    if (!index) {</span>
<span class="cstat-no" title="statement not covered" >      return options.complete();</span>
    }
&nbsp;
<span class="cstat-no" title="statement not covered" >    options.loadFile(index, <span class="fstat-no" title="function not covered" >function (err, data) {</span></span>
<span class="cstat-no" title="statement not covered" >      if (err) {</span>
<span class="cstat-no" title="statement not covered" >        return options.complete(err);</span>
      }
&nbsp;
<span class="cstat-no" title="statement not covered" >      var updatedContent = applyPatch(data, index, options);</span>
<span class="cstat-no" title="statement not covered" >      options.patched(index, updatedContent, <span class="fstat-no" title="function not covered" >function (err) {</span></span>
<span class="cstat-no" title="statement not covered" >        if (err) {</span>
<span class="cstat-no" title="statement not covered" >          return options.complete(err);</span>
        }
&nbsp;
<span class="cstat-no" title="statement not covered" >        processIndex();</span>
      });
    });
  }
<span class="cstat-no" title="statement not covered" >  processIndex();</span>
